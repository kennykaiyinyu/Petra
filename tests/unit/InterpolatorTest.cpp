...
// Test Fixture not strictly needed for static methods, but good practice
...
TEST_F(InterpolatorTest, InterpolatesMidpointsCorrectly) {
...
TEST_F(InterpolatorTest, ExtrapolatesFlatCorrectly) {
...
TEST_F(InterpolatorTest, ThrowsOnSizeMismatch) {
