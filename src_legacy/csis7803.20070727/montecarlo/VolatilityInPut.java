...
public class VolatilityInPut implements MathFunction {
	...
	private static double N_of_x(double x) {
	...
	private double putSellingPrice;
	private double rateOfReturn;
	private double timeToMaturity;
	
	public VolatilityInPut(double currentStockPrice, double strikePrice, double putSellingPrice, double rateOfReturn, double timeToMaturity) {
		this.currentStockPrice = currentStockPrice;
		this.strikePrice = strikePrice;
		this.putSellingPrice = putSellingPrice;
		this.rateOfReturn = rateOfReturn;
		this.timeToMaturity = timeToMaturity;
	}
	
	public double compute(double sigma) {
		...
		double n_of_minus_d1 = N_of_x(-d1);
		double d2 = d1 - sigmaSqrtT;
		double n_of_minus_d2 = N_of_x(-d2);
		return -this.putSellingPrice - this.currentStockPrice * n_of_minus_d1 + this.strikePrice * Math.exp(- this.rateOfReturn * this.timeToMaturity) * n_of_minus_d2;
	}
	...
	public static void main(String args[]) throws FailToConvergeException {
		...
		System.out.println(method.compute(new VolatilityInPut(29.12,27.5,7, 0.04173862261167498  ,deltaT), 0.00001, 1, 200));
	}
}
